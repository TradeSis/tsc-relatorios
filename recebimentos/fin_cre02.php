    ...
    <div class="container-fluid pt-3">
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            data-cliente="<?php echo $relatorio['parametros']['cliente'] ?>" 
                                            data-dtinicial="<?php echo $relatorio['parametros']['dtinicial'] ?>" 
                                            data-dtfinal="<?php echo $relatorio['parametros']['dtfinal'] ?>" 
                                            data-relatoriogeral="<?php echo $relatorio['parametros']['relatoriogeral'] ?>"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="form-group col">
                                    ...
                                    <input type="text" class="form-control" id="relatoriogeral" readonly>
                                </div>
                                <div class="form-group col">
        ...
        <script>
            $(document).on('click', 'a[data-bs-target="#parametros-modal"]', function() {
                var codigoFilial = $(this).attr("data-codigoFilial") == true ? "Geral" : "Filial";
                ...
                $('#relatoriogeral').val(relatoriogeral);

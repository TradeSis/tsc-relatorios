...
<body class="bg-transparent">
    ...
    <div class="container-fluid pt-3">
        <div class="row">
            <div class="col">
                <h5>Resumo Conciliação Crediário</h5>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-2 text-end">
                ...
                <a href="telaanaliini_inserir.php" role="button" class="btn btn-success btn-sm">Novo</a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-sm" href="#" data-bs-toggle="modal" data-bs-target="#parametros-modal"
                                                ...
                                                data-tipooperacao="<?php echo $relatorio['parametros']['tipooperacao'] ?>">Parâmetros</a>
                                        </td>
                                        <td class="text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-sm" href="#" data-bs-toggle="modal" data-bs-target="#parametros-modal"
                                                ...
                                                data-tipooperacao="<?php echo $agendamento['parametros']['tipooperacao'] ?>">Parâmetros</a>
                                        </td>
                                        <td>
                                            <a class="btn btn-sm btn-danger" href="#" data-bs-toggle="modal" data-bs-target="#excluirAgendamento-modal"
                                                ...
                                                data-periodicidade="<?php echo $periodicidade ?>"><i class="bi bi-trash"></i></a>
                                        </td>
                                    </tr>

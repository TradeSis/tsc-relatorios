<?php
// lucas 02102024 - criado programa
    ...
    <div class="container-fluid pt-3">
        ...
        <div class="row">
            ...
            <div class="col-2 text-end">
                ...
                <a href="relcpn-v012018_inserir.php" role="button" class="btn btn-success btn-sm">Novo</a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-sm" href="#" data-bs-toggle="modal" data-bs-target="#parametros-modal"
                                                ...
                                                data-etbcod="<?php echo $relatorio['parametros']['etbcod'] ?>">Parâmetros</a>
                                        </td>
                                        <td class="text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-sm" href="#" data-bs-toggle="modal" data-bs-target="#parametros-modal"
                                                ...
                                                data-etbcod="<?php echo $agendamento['parametros']['etbcod'] ?>">Parâmetros</a>
                                        </td>
                                        <td>

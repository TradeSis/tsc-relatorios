    ...
    <div class="container-fluid pt-3">
        ...
        <div class="row">
            ...
            <div class="col-2 text-end">
                ...
                <a href="cdleld2_inserir.php" role="button" class="btn btn-success btn-sm">Novo</a>
                        ...
                        <table class="table table-sm table-hover table-bordered text-center">
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-sm" href="#" data-bs-toggle="modal" data-bs-target="#parametros-modal" 
                                            data-etbIni="<?php echo $agendamento['parametros']['etb_ini'] ?>" 
                                            data-etbFim="<?php echo $agendamento['parametros']['etb_fim'] ?>" 
                                            >Parâmetros</a>
                                        </td>
                                        <td>
